    ...
    return (
        <>
            <div className="login-container">
                <h1 className="text-gradient">Ram-Nants</h1>
                <h2>Scribble down those 2am thoughts and ideas</h2>
                <p>Build your very own archive of easily navigated and indexed ideas and notes.</p>
                ...
                <div className="full-line"></div>
                <footer>
                    <a target="_blank" href="https://github.com/abhiram0811">
                        <img src="https://avatars.githubusercontent.com/u/93903261?v=4" alt="pfp" />
                        <h6>@abhira0811</h6>
